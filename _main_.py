...
# global restapi_register_name
# global restapi_register_password
# global restapi_adres
# global restapi_postcode
...
#     return
    ...
    # print (restapi_adres, restapi_postcode)
    # data = ({"Naam": restapi_register_name, "Password": restapi_register_password, "Adres": restapi_adres,
    #          "Postcode": restapi_postcode})
    # print ('testje')
    # r = requests.post('http://127.0.0.1:5000/registreren', json=data)
    # print ('nog een testje')
    # headers = {'Content-type': 'application/json'}
    # print ('functie is klaar')
...
if __name__ == "__main__":
    app.run(host='0.0.0.0',port=8080, debug=True, ssl_context=ctx)
